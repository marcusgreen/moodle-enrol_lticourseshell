...
namespace enrol_lticourseshell\local\ltiadvantage\admin;
...
class admin_setting_registeredplatforms extends \admin_setting {
    ...
    public function __construct() {
        $this->nosave = true;
        parent::__construct('enrol_lti_cs_tool_registered_platforms', get_string('registeredplatforms', 'enrol_lticourseshell'), '',
            '');
    }
