...
use enrol_lticourseshell\local\ltiadvantage\viewobject\published_resource;
...
class published_resource_repository {
    ...
    public function find_all_for_user(int $userid): array {
        ...
        $resources = array_filter($resources, function($resource) use ($userid) {
            return has_capability('enrol/lticourseshell:config', \context_course::instance($resource->courseid), $userid);
        });
