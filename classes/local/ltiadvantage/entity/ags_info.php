 ...
 *
 * For information about Assignment and Grade Services 2.0, see https://www.imsglobal.org/spec/lticourseshell-ags/v2p0/.
 *
...
class ags_info {
    ...
    private const SCOPES_RESULT_READONLY = 'https://purl.imsglobal.org/spec/lticourseshell-ags/scope/result.readonly';

    /** @var string Scope for posting scores.*/
    private const SCOPES_SCORES_POST = 'https://purl.imsglobal.org/spec/lticourseshell-ags/scope/score';
