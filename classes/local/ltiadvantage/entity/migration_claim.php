...
namespace enrol_lticourseshell\local\ltiadvantage\entity;
...
class migration_claim {
     ...
     * This is only included in the claim if it differs to the value included in the lticourseshell 1.3 'sub' claim.
     * I.e. https://www.imsglobal.org/spec/security/v1p0#id-token
     */
    private $userid = null;

    /** @var string the LTI 1.1 context identifier.
     * This is only included in the claim if it differs to the 'id' property of the lticourseshell 1.3 'context' claim.
     ...
     * This is only included in the claim if it differs to the 'guid' property of the lticourseshell 1.3 'tool_platform' claim.
     ...
     * This is only included in the claim if it differs to the 'id' property of the lticourseshell 1.3 'resource_link' claim.
    ...
    private function verify_signature(string $consumerkey, string $signature, string $deploymentid, string $platform,
        ...
        // Legacy enrol_lticourseshell code permits tools to share a consumer key but use different secrets. This results in
