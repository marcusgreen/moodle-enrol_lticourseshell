...
/**
 * Class user, instances of which represent a specific lticourseshell user in the tool.
 *
 * A user is always associated with a resource, as lticourseshell users cannot exist without a tool-published-resource. A user will
...
class user {
     ...
     * @param int $userid the id of the Moodle user to which this lticourseshell user relates.
     ...
     * @param int|null $id the id of this lticourseshell user instance, or null if it's a not-yet-persisted object.
     * @return user the user instance.
     */
