...
namespace enrol_lticourseshell\local\ltiadvantage\table;
...
class published_resources_table extends \table_sql {
    ...
    public function __construct($courseid) {
        ...
        $this->define_headers(array(
            get_string('name'),
            get_string('lticourseshell13launchdetails', 'enrol_lticourseshell'),
            get_string('edit')
        ));
        ...
        // Set help icons.
        $launchicon = new \help_icon('lticourseshell13launchdetails', 'enrol_lticourseshell');
    ...
    public function col_launch($tool) {
        ...
        $customparamslabel = get_string('customproperties', 'enrol_lticourseshell');
        $customparams = "id={$tool->uuid}";
        $launchurl = new \moodle_url('/enrol/lticourseshell/launch.php');
    ...
    public function col_edit($tool) {
        ...
        $url = new \moodle_url('/enrol/lticourseshell/index.php', array('sesskey' => sesskey(), 'courseid' => $this->courseid));
        ...
        if ($this->lticourseshellenabled && $this->canconfig) {
            $linkparams = array(
                ...
                'returnurl' => new \moodle_url('/enrol/lticourseshell/index.php', array('courseid' => $this->courseid))
            );
