...
class application_registration_service {
    ...
    private function get_unique_id(): string {
        ...
        } while ($DB->record_exists('enrol_lti_cs_app_registration', ['uniqueid' => $uniqueid]));
    ...
    /**
     * Application service handling the use case "As an admin I can update the registration of an lticourseshell platform".
     *
    ...
    /**
     * Application service handling the use case "As an admin I can delete a registration of an lticourseshell platform".
     *
