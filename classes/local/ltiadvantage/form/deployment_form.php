...
class deployment_form extends \moodleform {
    ...
    protected function definition() {
        ...
        // Name.
        $mform->addElement('text', 'name', get_string('adddeployment:name', 'enrol_lticourseshell'));
        $mform->setType('name', PARAM_TEXT);
        $mform->addRule('name', $strrequired, 'required', null, 'client');
        $mform->addRule('name', get_string('maximumchars', '', 255), 'maxlength', 255, 'client');

        // Deployment Id.
        $mform->addElement('text', 'deploymentid', get_string('adddeployment:deploymentid', 'enrol_lticourseshell'));
        ...
        $mform->addHelpButton('deploymentid', 'adddeployment:deploymentid', 'enrol_lticourseshell');
    ...
    public function validation($data, $files) {
        ...
        if ($deploymentrepo->find_by_registration($data['registrationid'], $data['deploymentid'])) {
            $errors['deploymentid'] = get_string('adddeployment:invaliddeploymentiderror', 'enrol_lticourseshell');
        }
