...
namespace enrol_lticourseshell\local\ltiadvantage\viewobject;
...
class published_resource {
    ...
    /** @var int id of the enrol_lti_cs_tools instance (i.e. the id of the 'published resource'). */
    private $id;
     ...
     * @param int $id id of the enrol_lti_cs_tools instance (i.e. the id of the 'published resource').
