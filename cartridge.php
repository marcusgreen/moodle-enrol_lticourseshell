...
if (!\enrol_lticourseshell\helper::verify_cartridge_token($toolid, $token)) {
...
if (!is_enabled_auth('lti')) {
...
} else if (!enrol_is_enabled('lticourseshell')) {
    ...
    echo \enrol_lticourseshell\helper::create_cartridge($toolid);
}
