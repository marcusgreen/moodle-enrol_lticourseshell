...
/**
 * lticourseshell 1.3 login endpoint.
 *
...
// See http://www.imsglobal.org/spec/security/v1p0/#step-1-third-party-initiated-login.
// Validate these here, despite further validation in the lticourseshell 1.3 library.
...
// - enrol/lticourseshell/launch.php endpoint (for regular resource link launches) or
...
if (!isloggedin()) {
    cookie_helper::do_cookie_check(new moodle_url('/enrol/lticourseshell/login.php', [
        'iss' => $iss,
    ...
    if (!cookie_helper::cookies_supported()) {
        ...
        $PAGE->set_url(new moodle_url('/enrol/lticourseshell/login.php'));
