 ...
 * @coversDefaultClass \enrol_lticourseshell\local\ltiadvantage\service\tool_deployment_service
 */
final class tool_deployment_service_test extends \lticourseshell_advantage_testcase {
    /**
    ...
    /**
     * Test the use case "As an admin, I can register an application as an lticourseshell consumer (platform)".
     *
    ...
    public function test_delete_deployment(): void {
        ...
        $this->assertNotEmpty(helper::get_lticourseshell_tool($resource->id));
    }
}
