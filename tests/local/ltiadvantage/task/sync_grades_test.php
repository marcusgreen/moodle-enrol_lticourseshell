...
/**
 * Tests for the enrol_lticourseshell\local\ltiadvantage\task\sync_grades scheduled task.
 *
 * @package enrol_lticourseshell
 * @copyright 2021 Jake Dallimore <jrhdallimore@gmail.com>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \enrol_lticourseshell\local\ltiadvantage\task\sync_grades
 */
final class sync_grades_test extends \lticourseshell_advantage_testcase {
    ...
    public function test_get_name(): void {
        $this->assertEquals(get_string('tasksyncgrades', 'enrol_lticourseshell'), (new sync_grades())->get_name());
    }
    ...
    public function test_sync_grades_gradesync_disabled(): void {
        ...
        $task = new \enrol_lticourseshell\local\ltiadvantage\task\sync_grades();
    ...
    /**
     * Test the grade sync task when the enrol_lticourseshell plugin is disabled.
     *
     * @covers ::execute
     */
    public function test_sync_grades_enrol_plugin_disabled(): void {
        ...
        $task = new \enrol_lticourseshell\local\ltiadvantage\task\sync_grades();
        $this->expectOutputRegex('/Skipping task - ' . get_string('enrolisdisabled', 'enrol_lticourseshell') . '/');
        $task->execute();
    }
}
