 ...
 * @coversDefaultClass \enrol_lticourseshell\local\ltiadvantage\entity\nrps_info
 */
final class nrps_info_test extends \advanced_testcase {
    ...
    public function test_create(array $args, array $expectations): void {
        if (!$expectations['valid']) {
            ...
            $this->assertEquals('https://purl.imsglobal.org/spec/lticourseshell-nrps/scope/contextmembership.readonly',
