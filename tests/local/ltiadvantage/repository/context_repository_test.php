 ...
 * @coversDefaultClass \enrol_lticourseshell\local\ltiadvantage\repository\context_repository
 */
final class context_repository_test extends \advanced_testcase {
    ...
    protected function assert_context_db_values(context $expected) {
        global $DB;
        $checkrecord = $DB->get_record('enrol_lti_cs_context', ['id' => $expected->get_id()]);
