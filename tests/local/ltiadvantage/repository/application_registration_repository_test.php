 ...
 * @coversDefaultClass \enrol_lticourseshell\local\ltiadvantage\repository\application_registration_repository
 */
final class application_registration_repository_test extends \advanced_testcase {
    ...
    protected function assert_registration_db_values(application_registration $registration) {
        global $DB;
        $record = $DB->get_record('enrol_lti_cs_app_registration', ['id' => $registration->get_id()]);
    ...
    public function test_delete(): void {
        ...
        $this->assertEquals(0, $DB->count_records('enrol_lti_cs_app_registration'));
