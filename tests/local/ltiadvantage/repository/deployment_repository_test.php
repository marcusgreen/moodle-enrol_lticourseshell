 ...
 * @coversDefaultClass \enrol_lticourseshell\local\ltiadvantage\repository\deployment_repository
 */
final class deployment_repository_test extends \advanced_testcase {
    ...
    protected function assert_deployment_db_values(deployment $expected) {
        global $DB;
        $checkrecord = $DB->get_record('enrol_lti_cs_deployment', ['id' => $expected->get_id()]);
