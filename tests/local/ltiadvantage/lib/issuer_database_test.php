 ...
 * @coversDefaultClass \enrol_lticourseshell\local\ltiadvantage\lib\issuer_database
 */
final class issuer_database_test extends \advanced_testcase {
    ...
    public function test_find_registration_by_issuer(): void {
        ...
        $appreg = application_registration::create(
            ...
            'client-id-123',
            new \moodle_url('https://lms.example.com/lticourseshell/auth'),
            new \moodle_url('https://lms.example.com/lticourseshell/jwks'),
            new \moodle_url('https://lms.example.com/lticourseshell/token')
        );
    ...
    public function test_find_deployment(): void {
        ...
        $this->assertInstanceOf(lticourseshellDeployment::class, $deployment);
