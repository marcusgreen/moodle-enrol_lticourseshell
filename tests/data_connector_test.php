...
final class data_connector_test extends \advanced_testcase {
    ...
    public function test_delete_tool_consumer(): void {
        ...
        $context = Context::fromConsumer($consumer, 'testlticourseshellcontext');
        $context->save();
        ...
        $user->lticourseshellResultSourcedId = 'testlticourseshellResultSourcedId';
        $dc->saveUser($user);
    ...
    public function test_load_resource_link(): void {
        ...
        $lticourseshellresourcelinkid = 'testlticourseshellresourcelinkid';
        $resourcelink = ResourceLink::fromConsumer($consumer, $lticourseshellresourcelinkid);
        $resourcelink->setContextId($context->getRecordId());
        ...
        $resourcelink2 = ResourceLink::fromConsumer($consumer, $lticourseshellresourcelinkid);
        ...
        $resourcelink2->lticourseshellResourceLinkId = $lticourseshellresourcelinkid . '2';
        $resourcelink2->save();
    ...
    public function test_save_resource_link(): void {
        ...
        $resourcelink->lticourseshellResourceLinkId = $lticourseshellresourcelinkid . 'edited';
    ...
    public function test_get_user_result_sourced_ids_resource_link(): void {
        ...
        $user = User::fromResourceLink($resourcelink, '');
        $user->lticourseshellResultSourcedId = 'testlticourseshellResultSourcedId';
        $user->lticourseshellUserId = 'user1';
        $dc->saveUser($user);

        $user2 = User::fromResourceLink($resourcelinkchild, '');
        $user2->lticourseshellResultSourcedId = 'testlticourseshellResultSourcedId2';
        $user->lticourseshellUserId = 'user2';
        $dc->saveUser($user2);
    ...
    public function test_load_user(): void {
        ...
        $this->assertEquals('testlticourseshellResultSourcedId', $user->lticourseshellResultSourcedId);
    ...
    public function test_save_user(): void {
        ...
        // Update user.
        $user->lticourseshellResultSourcedId = 'testlticourseshellResultSourcedId2';
        ...
        $this->assertEquals('testlticourseshellResultSourcedId2', $user->lticourseshellResultSourcedId);
    }
    ...
    public function test_delete_user(): void {
        ...
        $this->assertNull($user->lticourseshellResultSourcedId);
    ...
    public function test_get_contexts_from_consumer(): void {
        ...
        $context2 = Context::fromConsumer($consumer2, $lticourseshellcontextid . '2');
    ...
    public function test_get_consumers_mapped_to_tool(): void {
        ...
        $tool = $generator->create_lticourseshell_tool($data);
        ...
        $tp = new \enrol_lticourseshell\tool_provider($tool->id);
        ...
        $tp2 = new \enrol_lticourseshell\tool_provider($tool2->id);
