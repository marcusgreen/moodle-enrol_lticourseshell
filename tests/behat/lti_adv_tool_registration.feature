...
Feature: Register a platform with the tool
  ...
  Background:
    Given I enable "lticourseshell" "enrol" plugin

  Scenario: An admin can register a platform with the tool
    Given I log in as "admin"
    And I navigate to "Plugins > Enrolments > Publish as lticourseshell tool > Tool registration" in site administration
  ...
  Scenario: An admin can edit a platform's registration details
    Given the following "enrol_lticourseshell > application registrations" exist:
  ...
  Scenario: An admin can copy the manual and dynamic registration endpoints to register the tool with the platform
    ...
    And the "value" attribute of "Registration URL" "field" should contain "enrol/lticourseshell/register.php"
    And the "value" attribute of "Tool URL" "field" should contain "enrol/lticourseshell/launch.php"
    And the "value" attribute of "Initiate login URL" "field" should contain "enrol/lticourseshell/login.php"
    And the "value" attribute of "JWKS URL" "field" should contain "enrol/lticourseshell/jwks.php"
    And the "value" attribute of "Deep linking URL" "field" should contain "enrol/lticourseshell/launch_deeplink.php"
