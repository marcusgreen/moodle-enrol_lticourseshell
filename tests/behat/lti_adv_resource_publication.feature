...
Feature: Publish activities and resources over LTI Advantage
  ...
  Background:
    ...
    And I enable "lticourseshell" "enrol" plugin

  Scenario: A teacher can publish an activity
    Given I log in as "teacher1"
    And I am on the "Course 1" "enrolment methods" page
    When I select "Publish as lticourseshell tool" from the "Add method" singleselect
    And the following fields match these values:
    | lticourseshell version | LTI Advantage |
  ...
  Scenario: A teacher can switch the version of a published resource from lticourseshell 1.1 to LTI Advantage
    ...
    And "Legacy lticourseshell (1.1/2.0)" "link" should exist
