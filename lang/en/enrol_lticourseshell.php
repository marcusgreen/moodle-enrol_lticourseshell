...
$string['authlticourseshellmustbeenabled'] = 'Note: This plugin requires the LTI authentication plugin to be enabled too.';
...
$string['endpointltiversionnotice'] = 'The tool endpoints below are for manual lticourseshell 1.3 setup only. For earlier versions (1.1/2.0), details for consumers can be found on the \'Published as lticourseshell tools\' page, accessible via course navigation.';
...
$string['enrolisdisabled'] = 'The \'Publish as lticourseshell tool\' plugin is disabled.';
$string['enrolltiversionincorrect'] = 'The resource is not set up for use over legacy lticourseshell (versions 1.1/2.0). Please contact the administrator of this tool.';
...
$string['gradesync_help'] = 'Whether grades from the tool are sent to the remote system (lticourseshell consumer).';
...
$string['lticourseshelladvdynregerror:invalidopenidconfigjson'] = "There was a problem fetching the OpenID configuration from the platform. The result was not valid JSON. This may also be caused by blocked hosts configuration. Please make sure your site is configured to connect to the platform domain and try again using a new registration URL.";
$string['lticourseshelladvlauncherror:missingid'] = 'Invalid launch data. The custom claim field \'id\' is required to launch an activity or resource over LTI Advantage.';
$string['lticourseshelladvlauncherror:invalidid'] = 'Invalid launch data. The resource \'{$a}\' is unavailable or does not exist.';
$string['lticourseshelladvlauncherror:invalidregistration'] = 'Invalid launch data or tool configuration. A platform registration could not be found (issuer: {$a->platform}, client ID: {$a->clientid}).';
$string['lticourseshelladvlauncherror:invaliddeployment'] = 'Invalid launch data or tool configuration. The deployment could not be found (deployment ID: {$a}).';
$string['lticourseshelllegacy'] = 'Legacy LTI (1.1/2.0)';
$string['lticourseshelllegacydeprecatednotice'] = 'Legacy LTI (1.1/2.0) tools are deprecated. Content should now be shared using LTI Advantage.';
$string['lticourseshell13'] = 'LTI Advantage';
$string['lticourseshell13launchdetails'] = 'Launch details';
$string['lticourseshell13launchdetails_help'] = 'The launch URL and custom properties are only required when manually configuring a resource link in the platform. Where possible, teachers should favour the content selection (deep linking) process for the creation of resource links.';
...
$string['lticourseshell:config'] = 'Configure \'Publish as lticourseshell tool\' instances';
$string['lticourseshell:unenrol'] = 'Unenrol users from the course';
$string['opensslconfiginvalid'] = 'lticourseshell 1.3 requires a valid openssl.cnf to be configured and available to your web server. Please contact the site administrator to configure and enable openssl for this site.';
...
$string['pluginname'] = 'Publish as LTI Course shell tool';
$string['pluginname_desc'] = 'The \'Publish as LTI Course shell tool\' plugin, together with the LTI authentication plugin, allows remote users to access selected courses. In addition to the core LTI functionality it will duplicate a "shell course" on first access';
$string['privacy:metadata:enrol_lti_cs_users'] = 'The list of users enrolled via an lticourseshell provider';
$string['privacy:metadata:enrol_lti_cs_users:userid'] = 'The ID of the user';
$string['privacy:metadata:enrol_lti_cs_users:lastgrade'] = 'The last grade the user was recorded of having';
$string['privacy:metadata:enrol_lti_cs_users:lastaccess'] = 'The time when the user last accessed the course';
$string['privacy:metadata:enrol_lti_cs_users:timecreated'] = 'The time when the user was enrolled';
...
$string['registrationurlinfomessage'] = 'If the platform supports dynamic registration, use the registration URL below. For further information on dynamic registration, see the documentation <a href="{$a}">Publish as lticourseshell tool</a>.';
...
$string['secret_help'] = 'A string of characters which is shared with the remote system (lticourseshell consumer) to provide access to the tool.';
$string['sharedexternaltools'] = 'Published as LTI Course shell tools';
$string['successfulregistration'] = 'Successful registration';
$string['tasksyncgrades'] = 'Publish as LTI Course shell tool grade sync';
$string['tasksyncmembers'] = 'Publish as LTI Course shell tool users sync';
