 ...
 *
 * https://www.imsglobal.org/spec/lticourseshell-dr/v1p0
 *
...
if (is_null($draftreg) || $draftreg->is_complete()) {
    throw new moodle_exception('invalidexpiredregistrationurl', 'enrol_lticourseshell');
}
...
if (json_last_error() !== JSON_ERROR_NONE) {
    throw new moodle_exception('lticourseshelladvdynregerror:invalidopenidconfigjson', 'enrol_lticourseshell');
}
...
$regrequest = (object) [
    ...
    'initiate_login_uri' => $CFG->wwwroot . '/enrol/lticourseshell/login.php?id=' . $draftreg->get_uniqueid(),
    'redirect_uris' => [
        $CFG->wwwroot . '/enrol/lticourseshell/launch.php',
        $CFG->wwwroot . '/enrol/lticourseshell/launch_deeplink.php',
    ],
     // TODO: Consider whether to support client_name#ja syntax for multicourseshell language support - see MDL-73109.
    'client_name' => format_string($SITE->fullname, true, ['context' => system::instance()]),
    'jwks_uri' => $CFG->wwwroot . '/enrol/lticourseshell/jwks.php',
    'logo_uri' => $OUTPUT->get_compact_logo_url() ? $OUTPUT->get_compact_logo_url()->out(false) : '',
    'token_endpoint_auth_method' => 'private_key_jwt',
    'scope' => implode(" ", $scopes),
    'https://purl.imsglobal.org/spec/lti-tool-configuration' => [
        'domain' => $parsed['host'],
        'target_link_uri' => $CFG->wwwroot . '/enrol/lticourseshell/launch.php',
        'claims' => [
            'iss',
            'sub',
            'aud',
        ...
        'messages' => [
            (object) [
                ...
                'allowLearner' => false,
                'target_link_uri' => $CFG->wwwroot . '/enrol/lticourseshell/launch_deeplink.php',
                 // TODO: Consider whether to support label#ja syntax for multicourseshell language support - see MDL-73109.
                'label' => get_string('registrationdeeplinklabel', 'enrol_lticourseshell', $sitefullname),
                'placements' => [
                    "ContentArea"
                ],
            ],
            (object) [
                ...
                'target_link_uri' => $CFG->wwwroot . '/enrol/lticourseshell/launch.php',
                // TODO: Consider whether to support label#ja syntax for multicourseshell language support - see MDL-73109.
                'label' => get_string('registrationresourcelinklabel', 'enrol_lticourseshell', $sitefullname),
                'placements' => [
                    "ContentArea"
                ],
            ],
...
if ($regresponse) {
    ...
    if ($regresponse->client_id) {
        ...
        if ($appregrepo->find_by_platform($openidconfig->issuer, $regresponse->client_id)) {
            throw new moodle_exception('existingregistrationerror', 'enrol_lticourseshell');
        }
